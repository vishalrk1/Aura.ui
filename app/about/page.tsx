...
const page = () => {
  ...
  return (
    <>
      ...
      <main className="flex flex-col gap-32 p-20">
        <div className=" mt-[120px] items-center flex justify-between">
          <div className=" w-1/2 flex flex-col gap-4">
            ...
            <div className="flex gap-3">
              <a
                href="/components"
                className="text-center text-xl p-4 h-max w-36 rounded-lg bg-[#191e1f] border-2 border-[#292d2e] hover:bg-[#272f30] hover:scale-105 transition-all duration-200"
              >
                Explore
              </a>
              <a
          ...
          <div className="w-1/2 h-80 flex gap-2 items-center justify-center">
        ...
        <section className="flex flex-col gap-20">
          <motion.div
            className="text-center text-5xl font-extralight"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            ref={ref}
          ...
          <div className="px-60 grid sm:grid-cols-2 gap-12">
            {DevelopersData.map((item, index) => {
              return (
                <div className="items-center justify-center p-4 flex gap-11 hover:bg-[#191e1f] hover:border-2 hover:scale-105 hover: border-[#292d2e] transition-all ease-in duration-200  rounded-lg">
                  ...
                  <div className="flex flex-col gap-2">
                    <h1 className="m-0 text-3xl font-extralight">
                      {item.name}
                    </h1>
                    <h2 className="m-0 mb-1 text-xl text-white-a6">
                      {item.designation}
                    </h2>
                    <div className="flex gap-3 items-center">
                      <Link href={item.twitterURL} target="_blank">
                        <img src="/twitter-x.svg" className="h-6 w-6" />
                      </Link>
        ...
        <section className="flex flex-col gap-20">
          ...
          <form className="px-96 flex flex-col gap-4" action="">
            ...
            <div className="flex w-full justify-end items-center">
              <HoverFillButton className="rounded-lg">Submit</HoverFillButton>
            </div>
          </form>
        </section>
      </main>
